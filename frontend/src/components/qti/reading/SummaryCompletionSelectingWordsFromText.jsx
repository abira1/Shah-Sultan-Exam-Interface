...
/**
 * Summary Completion (Selecting Words from Text) - Reading
 * Complete summary using exact words from passage
 * Instructions: Write NO MORE THAN TWO WORDS from the passage
 * QTI Source: /app/Question type/Reading/Summary Completion (selecting words from the text)/
 */
const SummaryCompletionSelectingWordsFromText = ({ question, answer, onAnswerChange, onFocus }) => {
...
export default SummaryCompletionSelectingWordsFromText;

 ...
 * QTI Source: /app/Question type/Reading/Multiple choice with one answer/
 */
const MultipleChoiceOneAnswerReading = ({ question, answer, onAnswerChange, onFocus }) => {
...
export default MultipleChoiceOneAnswerReading;

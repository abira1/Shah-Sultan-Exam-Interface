...
/**
 * Flowchart Completion (Selecting Words from Text) - Reading
 * Complete flowchart by selecting words directly from passage
 * Instructions: Choose NO MORE THAN TWO WORDS from the passage
 * QTI Source: /app/Question type/Reading/Flow-chart Completion (selecting words from the text)/
 */
const FlowchartCompletionSelectingWordsFromText = ({ question, answer, onAnswerChange, onFocus }) => {
...
export default FlowchartCompletionSelectingWordsFromText;

 ...
 * QTI Source: /app/Question type/Reading/Multiple choice with more than one answer/
 */
const MultipleChoiceMoreThanOneAnswerReading = ({ question, answer, onAnswerChange, onFocus }) => {
...
export default MultipleChoiceMoreThanOneAnswerReading;

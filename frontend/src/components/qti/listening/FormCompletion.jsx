 ...
 * Fill out a form with personal/factual information
 * Instructions: Write NO MORE THAN THREE WORDS AND/OR A NUMBER
 * QTI Source: /app/Question type/Listening/Form Completion/
 */
const FormCompletion = ({ question, answer, onAnswerChange, onFocus }) => {
        ...
        <div className="flex-1">
          ...
          {max_words && (
            <p className="text-xs text-gray-500 mt-1">
              Maximum {max_words} word(s) and/or a number
            </p>
          )}
        </div>
      </div>

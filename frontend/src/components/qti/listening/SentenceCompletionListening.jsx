 ...
 * Complete sentences with missing words from audio
 * Instructions: Write NO MORE THAN TWO WORDS
 * QTI Source: /app/Question type/Listening/Sentence Completion/
 */
const SentenceCompletionListening = ({ question, answer, onAnswerChange, onFocus }) => {
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1">
          {/* Render prompt with inline input for blanks */}
...
export default SentenceCompletionListening;
